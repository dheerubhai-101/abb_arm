...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'models/aruco_marker'), glob('models/aruco_marker/*.sdf')),
        (os.path.join('share', package_name, 'models/aruco_marker'), glob('models/aruco_marker/*.config')),
    ],
    install_requires=['setuptools'],
    zip_safe=True,
    maintainer='bravelord',
    maintainer_email='dheerusatya.01@gmail.com',
